...
// the panel falls back to its generic row: this peek exists for the debugger's
// eyes, the engine remains the only authority on the format.
public static class JournalPeek
{
    ...
    public static string OneLine(string text, int max = 110)
    {
